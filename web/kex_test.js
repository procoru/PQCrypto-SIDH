...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'kex_test.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'kex_test.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'kex_test.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "kex_test.html.mem" : null;




var STATIC_BUMP = 14976;
