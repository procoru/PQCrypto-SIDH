...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'arith_test.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'arith_test.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'arith_test.temp.asm.js';
...
STATICTOP = STATIC_BASE + 17456;
  /* global initializers */  __ATINIT__.push();
  

memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "arith_test.html.mem" : null;




var STATIC_BUMP = 17456;
